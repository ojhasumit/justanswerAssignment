...
public class CreditCardpage extends BaseClass {
    ...
    private String options = "//div[@class='dropdown__option' and text() = '%1s']";
    private String dropDown = "//div[@class='dropdown__current js-dropdown-current' and text() = '%1s']";
    private String emailIdXapth = "//input[@id='input-email']";
    private String submitButtonXpath = "//button[@id='cta-form-submit']";
    ...
    public void enterEmail(String email) {
        By email_id = By.xpath(emailIdXapth);
        waitForVisibility(driver, email_id, 30);
    ...
    @Step("Clicked on Submit")
    public void clickSubmit() {
        By submitButton = By.xpath(submitButtonXpath);
        waitForVisibility(driver, submitButton, 30);
        submit.click();
    }
    ...
    @Step("Select Expiry Date and Year {0} {1}")
